...
export const oceanProjectConfig = createProjectConfig({
  ...
  content: {
    ...
    heroSubtitle: 'Explorá Ocean Mansions, recorré sus niveles y encontrá la unidad que mejor se adapta a vos.',
    introTitle: 'Arquitectura para vivir el horizonte.',
    introText: 'Un proyecto residencial pensado para combinar arquitectura, amenities y una ubicación privilegiada frente al paisaje de Punta del Este.',
    unitsEyebrow: 'INVENTARIO',
    unitsTitle: 'Elegí tu unidad.',
    unitsText: 'Compará superficies, dormitorios, precios y disponibilidad.',
    amenitiesEyebrow: 'EXPERIENCIA',
    amenitiesTitle: 'Más que una residencia.',
    amenitiesText: 'Espacios diseñados para acompañar cada momento del día.',
    locationEyebrow: 'UBICACIÓN',
    locationTitle: 'Todo cerca. El mar, primero.',
    locationText: 'Playa Mansa, servicios, gastronomía y el ritmo de Punta del Este a pocos minutos.',
